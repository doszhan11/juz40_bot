...
SUBJECT_MANAGERS = {
    "ДЖТ-ENG":   [("Айшуақ Садық", "@shuaq140", 7203074036)],
    ...
    "РУС-ЛИТ":   [("Айдар Гаухария", "@riyaa_drr", 975017993)],
    "БИО-ГЕО":   [("Тлекбаева Альбина", "@tallbyna", 1727473222)],
}
CREATIVE_MANAGERS = [("Бегалы Алтынай", "@altynai_tarikh", 7921367924)]
...
ADMIN_IDS = {7203074036, 6479767513}
